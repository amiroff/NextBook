...
function SideBar() {
  ...
  const sideBarStyle = sideBarCtx.sideBar
    ...
    : 'sidebar z-50 shrink h-screen fixed top-10 md:top-14 hidden md:block pl-4 pr-4 border-r dark:border-gray-600 h-full overflow-y-auto max-w-72 bg-[#ffffff] dark:bg-gray-800'
