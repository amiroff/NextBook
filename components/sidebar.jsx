...
function SideBar() {
  ...
  return sideBarCtx.sideBar ? (
    <div className='sidebar text-sm z-50 flex-none w-full bg-gray-100 dark:bg-gray-700 h-screen overflow-y-auto fixed top-12 md:hidden'>
      {toc.map((toc, id) => (
    ...
    <div
      className={`sidebar text-sm z-50 flex-none md:w-56 xl:w-64 h-screen overflow-y-auto fixed top-12 hidden md:block ${
        isBrowser && isWindows
