...
function SideBar() {
  ...
  const sideBarStyle = sideBarCtx.sideBar
    ? 'sidebar w-2/3 z-50 h-screen bg-[#ffffff] dark:bg-gray-800 border-t border-r border-gray-300 dark:border-gray-800 fixed pl-4 text-lg top-10 md:hidden'
    : 'sidebar z-50 shrink h-screen fixed top-10 md:top-14 hidden md:block pl-4 pr-4 border-r dark:border-gray-600 h-full overflow-y-auto max-w-xs bg-[#ffffff] dark:bg-gray-800'
